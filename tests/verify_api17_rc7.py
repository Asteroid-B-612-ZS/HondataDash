#!/usr/bin/env python3
"""Static/API17 and hot-path resource checks for V2.1 OEM visual preview 2."""
...
assert re.search(r'\bversionCode\s+54\b',BUILD)
assert re.search(r'versionName\s+["\']2\.1\.0-visual\.2["\']',BUILD)

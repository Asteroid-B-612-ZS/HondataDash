#!/usr/bin/env python3
"""Static/API17 and hot-path resource checks for V2.0.1-internal."""
...
assert re.search(r'versionName\s+["\']2\.0\.1-internal["\']',BUILD)
...
print('PASS: V2.0.1-internal API17/static semantic hot-path and bounded-memory contracts')

#!/usr/bin/env python3
"""Static/API17 and hot-path resource checks for V2.1 OEM visual preview."""
...
assert re.search(r'\bversionCode\s+53\b',BUILD)
assert re.search(r'versionName\s+["\']2\.1\.0-visual\.1["\']',BUILD)

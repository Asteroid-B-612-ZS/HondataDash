...
assert re.search(r'versionName\s+["\']2\.0\.1-internal\.3-hf1["\']',BUILD)
...
print('PASS: V2.0.1-internal.3-hf1 API17/static semantic hot-path and bounded-memory contracts')

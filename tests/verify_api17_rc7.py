...
assert re.search(r'versionName\s+["\']2\.0\.1-internal\.3-hf3["\']',BUILD)
...
print('PASS: V2.0.1-internal.3-hf3 API17/static semantic hot-path and bounded-memory contracts')
